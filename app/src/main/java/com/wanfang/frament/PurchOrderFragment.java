...
public class PurchOrderFragment extends Fragment implements OnClickListener {

	public final static String CITY_LIST_POSITION = "position";
	int mCurrentPosition = -1;
	OnMenuPurchOrderClickedListener mCallback;
	private TextView UserName;
	
	// Container Activity must implement this interface
    public interface OnMenuPurchOrderClickedListener {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (OnMenuPurchOrderClickedListener) activity;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.purchorder_fragment_layout, null);
