...
public class PlaceOrderFragment extends Fragment implements OnClickListener {

	public final static String CITY_LIST_POSITION = "position";
	int mCurrentPosition = -1;
	OnMenuPlaceClickedListener mCallback;
	private TextView userName;
	
	// Container Activity must implement this interface
    public interface OnMenuPlaceClickedListener {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (OnMenuPlaceClickedListener) activity;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.placeorder_fragment_layout, null);
